...
class NewMessage(QDialog):
    ...
    def initUi(self):
        ...
        window_pale.setBrush(self.backgroundRole(),\
            QBrush(QPixmap("UI/image/newmessage.jpg"))) 
        ...
        # 程序名
        self.lbl_main = QLabel('发布货运信息', self)
        ...
        self.l4 = ['无要求','20-50万','50-100万','100-300万','300万以上']
        x = 100
        ...
        self.Edit_bulk.setStyleSheet(lucency)
        ...
        self.weight.setStyleSheet(lucency)
        ...
        self.Edit_total.setStyleSheet(lucency)
        ...
        self.text_describe.setGeometry(100, 340, 400, 150)
        self.text_describe.setToolTip('300字以内')
        self.text_describe.setStyleSheet(lucency)
        ...
        self.Edit_phone.setText(self.user)
        self.Edit_phone.setStyleSheet(lucency)
        ...
        self.button_issue.setStyleSheet(color2 % 'UI/image/newissue.png')
        self.button_issue.clicked.connect(self.onissue)

        self.centralwidget = QWidget(self)
        self.centralwidget.setGeometry(350, 555, 250, 40)
    ...
    def onissue(self):
        ...
        data = 'F ' + self.user + ' ' + s_province + '#' + s_city + '#' +\
    ...
    def handle_return_message(self,mess):
        ...
        if mess == 'FFNO NoData':
            self.issue_Error_hint('*发布失败')
        elif mess == 'FFOK ':
            self.issue_Error_hint('*发布成功')
        else:
            pass
        # 把按键检测变为False
        self.timekey = False
